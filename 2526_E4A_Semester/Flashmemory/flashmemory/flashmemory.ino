...
void setup()
{
  ...
  Serial.println(F("Start: Font aus normalem RAM-Zugriff"));
  Serial.print(F("Anzahl Zeichen: ")); //programmspeicher: 3272, sram: 1542
                                       //programmspeicher: 3330, sram: 1468
  ...
  for (uint16_t k = 0; k < sizeof(font) / FONT_BREITE; ++k)
  {
    ...
    {
      zeichen[i] = pgm_read_byte(font + k * FONT_BREITE + i); //font[k * FONT_BREITE + i];
    }
